#!/bin/bash
#$ -N qsub_coassembly_2files
#$ -o /u/scratch/b/big2258/coldcreekanvio/coassembly_files/2sample_files.1031
#$ -e /u/scratch/b/big2258/coldcreekanvio/coassembly_files/2sample_files.1031
#$ -cwd 
#$ -l h_data=6.25G
#$ -l h_rt=23:00:00
#$ -l h_vmem=25G
...
megahit -1 $R1s -2 $R2s --min-contig-len $MIN_CONTIG_SIZE -m 0.85 -o 02_ASSEMBLY.mini.1031/ -t $NUM_THREADS
